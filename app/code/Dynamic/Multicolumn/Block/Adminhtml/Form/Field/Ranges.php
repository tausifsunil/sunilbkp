<?php
namespace Dynamic\Multicolumn\Block\Adminhtml\Form\Field;

use Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray;
use Magento\Framework\DataObject;
use Magento\Framework\Exception\LocalizedException;
use Dynamic\Multicolumn\Block\Adminhtml\Form\Field\TaxColumn;
...
class Ranges extends AbstractFieldArray
{
    ...
    {
        $this->addColumn('from_qty', ['label' => __('Attributes'), 'class' => 'required-entry']);
        $this->addColumn('tax', [
            'label' => __('Tooltip'),
