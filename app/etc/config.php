...
return [
    'modules' => [
        ...
        'Amazon_Payment' => 1,
        'Ammertech_Module' => 0,
        'Categoryattribute_Custome' => 0,
        'Categorycustom_Attributeset' => 0,
        'Categoryproduct_Getproduct' => 0,
        'Cmsblockcall_Cmsblock' => 1,
        'Configcreat_Customconfig' => 0,
        'Controllersimple_Example' => 0,
        'Customefilter_Sortproducts' => 0,
        'Customergroup_Product' => 0,
        'Customheader_Modification' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dynamic_Multicolumn' => 0,
        'Filterstooltip_Layerednavigation' => 0,
        'Formdata_Banners' => 0,
        'Graphql_Createquery' => 1,
        'Graphql_Custome' => 1,
        'Grid_Banners' => 1,
        'Grid_Slider' => 0,
        'Homepage_Customization' => 0,
        'Homepagebanners_Banners' => 0,
        'Homepagetoadmin_Senddata' => 0,
        'Ict_Buynow' => 0,
        'Ict_Quickorder' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Learning_HelloPage' => 0,
        'Logtable_Getdata' => 0,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Magepow_SpeedOptimizer' => 0,
        'Magetrend_PdfTemplates' => 1,
        'Myvendor_Mymodule' => 0,
        'Newslatter_Custom' => 0,
        'Observerdemo_Changeprice' => 0,
        'Observerdemo_Changeqty' => 0,
        'Observerdemo_Example' => 0,
        'Observerdemo_Textobserver' => 0,
        'Overrideui_Sales' => 0,
        'Plugindemo_Changeprice' => 0,
        'Plugindemo_Example' => 0,
        'Plugindemo_Pluginqty' => 1,
        'Popup_Demo' => 0,
        'Preferencedemo_Changeprice' => 0,
        'Preferencedemo_Changeqty' => 0,
        'Preferencedemo_Example' => 0,
        'ProductAttribute_Custom' => 0,
        'Producttab_Custom' => 0,
        'Qtyincrement_Customize' => 0,
        'Shippingcart_Shipcharge' => 1,
        'Simplerouter_Demo' => 1,
        'Slider_Customization' => 0,
        'Snk_Captcha' => 1,
        'Summerytab_Customtab' => 0,
